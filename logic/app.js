...
var prompt = document.querySelector('.prompt'),
	...
	// the keyboard cheatsheet area
	cheatsheetContainer = document.querySelector('.cheatsheetContainer');
...
var showKeyboard = !localStorage.getItem('showKeyboard') || localStorage.getItem('showKeyboard') === 'true'; // true by default.
...
var preferenceButton = document.querySelector('.preferenceButton'),
	...
	showKeyboardToggle = document.querySelector('.showKeyboard');
...
function start() {
	...
	showKeyboardToggle.checked = showKeyboard;
...
function toggleCheatsheetUI() {
	cheatsheetContainer.classList.toggle('noDisplay');
}

showKeyboardToggle.addEventListener('click', () => {
